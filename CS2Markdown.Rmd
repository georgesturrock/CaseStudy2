...
Two R libraries were used to address the requirements for both sections.  "ggplot2" is used for all visualizations.  "dplyr" is used to cleanse and manipulate data.
